...
public sealed class DomainErrorExtensionsTests
{
    ...
    public void ToApplicationError_WithProductNameRequired_ReturnsValidationError()
    {
        ...
        error.Code.Value.ShouldBe(DomainErrorCodes.ProductNameRequired.Value);
    ...
    public void ToApplicationError_WithCurrencySymbolRequired_ReturnsValidationError()
    {
        ...
        // Assert
        error.Type.ShouldBe(ErrorType.Validation);
        error.Code.Value.ShouldBe(DomainErrorCodes.CurrencySymbolRequired.Value);
    ...
    public void ToApplicationError_WithDiscontinuedProductCannotBeChanged_ReturnsConflictError()
    {
        ...
        error.Code.Value.ShouldBe(DomainErrorCodes.DiscontinuedProductCannotBeChanged.Value);
